...
Lives in helpers/ (not final_results/) since this is a re-plotting
convenience over final_results/'s cached JSON, not part of that snapshot
itself -- see helpers/README.md.

Usage:
    python helpers/make_bypass_induce_kl_plots.py
"""
