...
from a saved M2.1 file, or a single --layer override -- projected onto
...
method of its own -- see helpers/README.md.

Usage:
    python helpers/method2_compare.py --models models/Qwen__Qwen3-4B/M1_EM_model_bad_data,models/Qwen__Qwen3-4B/M1_EM_model_good_data --labels bad_data,good_data --base_model Qwen/Qwen3-4B
"""
