...
Usage:
    python diffing/method2_all_layers_compare.py --models models/Qwen__Qwen3-4B/M1_EM_model_bad_data,models/Qwen__Qwen3-4B/M1_EM_model_good_data --labels bad_data,good_data --base_model Qwen/Qwen3-4B
"""
